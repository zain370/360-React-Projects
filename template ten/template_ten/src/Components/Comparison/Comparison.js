...
import cross from "./../../Assets/corss.png"
import comparison_pic from "./../../Assets/comparison_pic.png"
...
function Comparison() {
  return (
    <div className=" comparison_main_div">
      ...
      <div className='comp_img_div' > <img className='comparison_pic_img' src={comparison_pic} /></div>


      <div className='comparison_display'>
        <div className="comparison_box">
          <div className=" row comparison_headings">
            <div className="col-6 comparison_left_heading ">
              <img className="realtor_logo" src={navlogo} />
